...
public class HttpUtils {
	...
	public static JSONObject imgUpload(String urlStr, Map<String,String> headParams,Map<String, String> params,
		...
		String requestUrl = urlConvert.reconstructURL(urlStr);
		logger.info("doAsyncGet - requestUrl: {}, headers: {},params: {}", requestUrl, JSONObject.toJSON(headParams), JSONObject.toJSON(params));
		String res = "";
